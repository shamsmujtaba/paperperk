    ...
    <div class="container div-no-padding">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <h1 class="center margin-b-1 ">Don't Let Plagiarism Slip Through the Cracks: Detect It Now</h1>
                <p class="text-center margin-b-2 ">Avoid getting scooped. Ensure your paper is 100% original with the fastest and most free plagiarism checker.
                </p>
                <h2 class="center margin-b-1 ">An Advanced Plagiarism Tool to Unlock Your Content’s Potential</h2>
                <p class="text-center margin-b-2 ">Using our free duplicate content checker is the best way to ensure you never accidentally plagiarize. Just type in the text you want to check, and we'll analyze it in seconds. </p>
                <p class="text-center margin-b-2 ">We'll flag potential plagiarism and show you how much was taken from each source. Free version available!</p>
            </div>
        </div>
