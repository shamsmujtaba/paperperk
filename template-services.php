     ...
     <div class="container-fluid serv-banner-bg">
        ...
        <div class="container">
            ...
            <div class="col-md-4 col-md-offset-1">
                ...
                <div class="bg-new-bn"><img src="<?php bloginfo('template_directory'); ?>/images/top-hd-new-bn.webp" class="img-responsive" alt="top-hd-new-bn" /></div>

                

                <div class="calc-pr-new-bn">
                    ...
                    <div class="hd-form-head-new-bn">



                      <form action="https://order.paperperk.com/portal/main/orderStepOne" method="post">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-12">
                    ...
                    <select class="select-new-bn" id="documentType" name="documentType" onmouseover="fetchDocumentType()">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-12">
                    ...
                    <select name="acedamic_level" class="select-new-bn">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-12">
                    ...
                    <select name="pages" class="select-new-bn" id="no_of_pages" onmouseover="fetchNoOfPages()">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6 mob-gap">



                    <select name="hours" class="select-new-bn" onmouseover="fetchHours()" id="my-hours">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="hd-ord-new-bn"><button type="submit">Calculate Now</button></div>
...
<div class="container content-container pb-1">
  ...
  <div class="row headline">
    ...
    <div class="col-md-12">
      ...
      <h2>Bundles of Features To Enjoy When You Buy Cheap Essay Writing Service.
...
<div class="row headline">
  ...
  <div class="col-md-12">
    ...
    <h2 class="white" style=" color: #ed2354!important; ">We Are The Guarantor Of Your Future When You Buy Cheapest Essay From Us.</h2>
            ...
            <div class="white-box-round">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <div class="box-img"><img src="<?php bloginfo('template_directory'); ?>/images/jane-doe.webp" alt="jane-doe" /></div>
            ...
            <div class="white-box-round">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <div class="box-img"><img src="<?php bloginfo('template_directory'); ?>/images/john-doe.webp" alt="john-doe" /></div>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="st-box">
          ...
          <div class="trust-img"><img src="<?php bloginfo('template_directory'); ?>/images/unique-papers.webp" alt="unique-papersr" /></div>
      ...
      <div class="col-md-4">
        ...
        <div class="st-box">
          ...
          <div class="trust-img"><img src="<?php bloginfo('template_directory'); ?>/images/confidencial.webp" alt="confidencial" /></div>
      ...
      <div class="col-md-4">
        ...
        <div class="st-box">
          ...
          <div class="trust-img"><img src="<?php bloginfo('template_directory'); ?>/images/moneyback.webp" alt="moneyback"/></div>
  ...
  <div class="container center pb-1">
   ...
   <!-- </div>-->
    ...
    <div style="margin-left: -33px;">
        ...
        <div class="container padding-t-5 padding-b-5 stp-container1 background-white">

            <div class="row">

                <div class="col-lg-4 col-md-6 padding-lr-2 mrmbalr">



                    <div class="col-sm-12">

                        <h3 class="order-step-heading text-center">Step 1: Provide Details</h3>



                        <div class="para-text text-center text-dark padding-t-2 padding-b-2">

                            <p>Give essential info, like academic level, paper type, number of pages, citation

                                style,

                                and deadline. Then, proceed to payment.</p>

                        </div>



                        <div class="dots visible-lg-3 "></div>

                        <!-- <hr class="dots border-dotted"> -->





                        <div class="step-image-div margin-t-2">

                            <img class="step-image img-responsive" src="<?php bloginfo('template_directory'); ?>/images/Forms-amico.webp" alt="Forms-amico">
                ...
                <div class="col-lg-4 col-md-6 padding-lr-2 mb-container-n mrmbalr">



                    <div class="col-sm-12 order-md-2 order-sm-2">



                        <div class="step-image-div ">

                            <img class="step-image img-responsive" src="<?php bloginfo('template_directory'); ?>/images/E-Wallet-pana.webp" alt="E-Wallet-pana">
                        ...
                        <div>
                            ...
                            <h3 class="order-step-heading text-center padding-t-2">Step 2: Choose the Writer</h3>
                        ...
                        <div class="para-text text-center text-dark padding-t-2 padding-b-2">
                            ...
                            <p>After confirming your payment, we will help you choose an experienced writer to work
                ...
                <div class="col-lg-4 col-md-6 padding-lr-2 mb-container mrmbalr">
                    ...
                    <div class="col-sm-12 order-md-2 order-sm-2">
                        ...
                        <div class="step-image-div ">
                            ...
                            <img class="step-image img-responsive" src="<?php bloginfo('template_directory'); ?>/images/E-Wallet-pana.webp" alt="E-Wallet-pana-01">
                ...
                <div class="col-lg-4 col-md-6 padding-lr-2 mrmbalr">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div>
                            ...
                            <h3 class="order-step-heading text-center">Step 3: Get the Paper</h3>
                        ...
                        <div class="para-text text-center text-dark padding-t-2 padding-b-2">
                            ...
                            <p>After your paper is complete, you'll receive instructions on how to download your

                                paper via email. Review the paper and request revisions, if needed.</p>

                        </div>



                        <div class=" dots-angle d-none d-lg-block"></div>



                        <div class="step-image-div  ">

                            <img class="step-image img-responsive" src="<?php bloginfo('template_directory'); ?>/images/E-Wallet-pana.webp" alt="E-Wallet-pana-02">
    ...
    <div class="glossymenu">
      ...
      <div class="col-md-10 col-md-offset-1">
        ...
        <h3>
          ...
          <a class="menuitem submenuheader" href="#">Is it OK to buy an essay?</a>
        ...
        <div class="submenu">
          ...
          <div class="p-faq">
            ...
            <p>Buying an essay is highly recommended, especially when you suffer from the following situations.</p>
      ...
      <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1">
          ...
          <div class="col-md-10 col-md-offset-1">
            ...
            <p>Why bother asking your classmates and friends for cheap essay writers when all you have to do is to hire our team? We make sure to help you whenever you need us. Our expert college essay writers are available 24/7 regardless of the weekends, midnight, etc.&nbsp;</p>
